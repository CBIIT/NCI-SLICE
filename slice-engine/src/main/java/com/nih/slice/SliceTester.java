				...
				if (!final_line.isEmpty()) {
					...
					if (ghostMolecules.equals(activated)) {
						if (inchikey.equals(activated)) {
							...
							//System.out.println(final_line.replaceAll(":\\d+",""));
							URL nih_url = new URL("https://cactus.nci.nih.gov/chemical/structure/" + encodeSmile + "/inchikey");
							...
							String product_inchi = read_response.readLine();
							read_response.close();
							outputFile.write(product_inchi);
						} else {
